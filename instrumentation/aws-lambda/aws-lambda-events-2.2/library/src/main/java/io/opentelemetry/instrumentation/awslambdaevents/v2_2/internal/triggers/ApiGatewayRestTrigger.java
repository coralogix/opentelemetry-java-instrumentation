...
public final class ApiGatewayRestTrigger extends Trigger {
  ...
  public void onStart(AttributesBuilder attributes, Context parentContext,
    ...
    try {
      ...
      attributes.put("test.null.attribute", (String) null);
      ...
      attributes.put(HTTP_URL, getHttpUrl(req, lowercaseMap(request.getHeaders())));
      ...
      Map<String, List<String>> mvHeaders = orEmpty(req.getMultiValueHeaders());
