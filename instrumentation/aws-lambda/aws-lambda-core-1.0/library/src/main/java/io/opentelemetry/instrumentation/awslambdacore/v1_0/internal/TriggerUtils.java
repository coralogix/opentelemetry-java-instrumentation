...
public class TriggerUtils {
  ...
  public static final AttributeKey<String> RPC_REQUEST_PAYLOAD =
      AttributeKey.stringKey("rpc.request.payload");
  public static final AttributeKey<String> RPC_RESPONSE_PAYLOAD =
      AttributeKey.stringKey("rpc.response.payload");
  ...
  public static final AttributeKey<String> FAAS_TRIGGER_TYPE =
      AttributeKey.stringKey("faas.trigger.type");
